...
class _AuditorCheckTile extends StatelessWidget {
  const _AuditorCheckTile({
...
class _AuditorAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = _gradients[auditor.nama.hashCode.abs() % _gradients.length];
