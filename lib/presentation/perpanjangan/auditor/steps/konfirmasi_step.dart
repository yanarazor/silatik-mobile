...
/// Biaya perpanjangan per auditor — display only (backend otoritatif).
const int kAuditorExtFee = 750000;

/// Step 2 — konfirmasi biaya + ajukan.
class KonfirmasiStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final total = kAuditorExtFee * count;
    return Padding(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      AppFormatters.formatRupiah(kAuditorExtFee),
