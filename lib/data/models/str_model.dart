class StrModel {
  ...
  factory StrModel.fromJson(Map<String, dynamic> json) => StrModel(
        nomor: json['nomor'] ?? '',
        tanggalTerbit: json['tanggal_terbit'] != null ? DateTime.parse(json['tanggal_terbit']) : null,
        berlakuHingga: json['berlaku_hingga'] != null ? DateTime.parse(json['berlaku_hingga']) : null,
      );
